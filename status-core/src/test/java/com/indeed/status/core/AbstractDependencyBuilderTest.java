...
public class AbstractDependencyBuilderTest {
    /**
     * Mimic the common existing extended builders in client applications. Ensure any parametric typing changes we
     *  make in status-core do not cause downstream ripples.
     */
    @Test
    ...
    private static class ExistingExtendedBuilder extends AbstractDependencyBuilder<SimpleDependency, ExistingExtendedBuilder> {
