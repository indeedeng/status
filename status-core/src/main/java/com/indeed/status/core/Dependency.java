 ...
 *  remote dependency to assert its availability. The status of the remote dependency is captured
 *  in the {@link CheckResult} returned by the executable method.
 * </p><p>
 * The dependency implementation may be triggered by multiple threads simultaneously, and thus must be
